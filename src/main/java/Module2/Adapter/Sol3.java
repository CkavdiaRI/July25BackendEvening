...
public class Sol3 {
    public static void main(String[] args) {
        ...
        BankAPI3 icicBankAdapter = new ICICBankAdapter(icicBank);
        PhonePe3 phonePeICICI = new PhonePe3();
        phonePeICICI.pay(icicBankAdapter, 400.0);
        System.out.println("ICICI Balance: " + icicBankAdapter.getBalance());
    }
}

// No voilation of open closed principle
